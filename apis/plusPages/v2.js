...
/**
 * 'https://www.googleapis.com/upload/plusPages/v2/people/' . $id . '/media/cloud?key=' . $config['developer_key'];
 * 'https://www.googleapis.com/upload/plusPages/v2/people/' . $id . '/media/cloud?key=' . $config['developer_key'];
 * 'https://www.googleapis.com/plusPages/v2/people/me/people/pages?key=' . $config['developer_key'];
 * 'https://www.googleapis.com/plusPages/v2/people/' . $id . '/circles?key=' . $config['developer_key'];
 * 'https://www.googleapis.com/plusPages/v2/people/search?key=' . $config['developer_key'] . '&search=';
 * 'https://www.googleapis.com/plusPages/v2/activities/' . $param['param']['activityId'] . '/comments?key=' . $config['developer_key'] . '&onBehalfOf=' . $param['page_id'];
 * 'https://www.googleapis.com/plusPages/v2/people/' . $id . '/activities?key=' . $config['developer_key'];
 * 'https://www.googleapis.com/plusPages/v2/people/' . $id . '/activities?key=' . $config['developer_key'];
 * 'https://www.googleapis.com/upload/plusPages/v2/people/' . $id . '/activities?key=' . $config['developer_key'];
 * 'https://www.googleapis.com/upload/plusPages/v2/people/105351351863874932295/activities?key=AIzaSyCtI4epTLTtCwOSvD6aKBRN6mRekJ4iHPE
 * 'https://www.googleapis.com/plusPages/v2/people/105351351863874932295/activities?key=AIzaSyCtI4epTLTtCwOSvD6aKBRN6mRekJ4iHPE
 */
/**
 * Google+ API
 *
 ...
 * @variation v2
 * @this Pluspages
 * @param {object=} options Options for Pluspages
 */
function Pluspages(options) {
  ...
  this.activities = {
     ...
     *
     * @alias plusPages.activities.get
     * @memberOf! plus(v1)
     *
    ...
    get: function(params, callback) {
      var parameters = {
        options: {
          url: 'https://www.googleapis.com/plusPages/v2/people/{userId}/activities',
          method: 'GET'
        },
        params: params,
...
/**
 * Exports Pluspages object
 * @type Pluspages
 */
module.exports = Pluspages;